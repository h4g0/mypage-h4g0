...
// Página igual à pagina de send reception(Produtos.tsx) teve de ser criada outra porque depois de obter uma receção com erros ao alterar 
// o codigo será feito uma troca entre estas duas paginas para não haver conflitos com os estados
export function ProductsToEdit(props:any) {
    ...
    if (menu !== Menus.ProductsToEdit) return null
    ...
    const sendReception = async (e) => {
        ...
        //console.log(e.target.codigoentidade.value)
            ...
            return (
                <div className="WorkPlaceContainer">
                    ...
                    <div className="tableContainer" >
                        ...
                        <div className="submitContainer">
                            <div>
                                <Alert variant="warning">Produtos não existentes no WMS: {productsError}</Alert>
                            </div>
                            <div>
                                <Button onClick={deleteFile}>Delete File</Button>
                                <Button type="submit" className="send">Send Reception</Button>
